    ...
    <>
      ...
      >
        ...
        >
          ...
          <button
            onClick={onClose}
            className="ml-3 w-8 h-8 rounded-lg flex items-center justify-center text-lg hover:opacity-70"
            style={{
          ...
          {(task?.comments || []).map((comment: Comment) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`max-w-[240px] flex flex-col gap-1 ${
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span
                      ...
                      style={{
                        background: isMohammed
                          ? "rgba(59,130,246,0.15)"
                          : "rgba(245,158,11,0.15)",
                        color: isMohammed ? "#60a5fa" : "#fbbf24",
                        fontSize: "10px",
                      }}
                    >
                      {roleLabel}
          ...
          <form onSubmit={handleSubmit} className="flex gap-2">
            ...
            <div className="flex-1 flex gap-2">
              ...
              <button
                ...
                style={{
                  background: "linear-gradient(135deg,#163a63,#244f80)",
                  flexShrink: 0,
                }}
              >
                {submitting ? "…" : "↑"}
